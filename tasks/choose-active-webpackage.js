...
var inquirerPath = require.resolve('inquirer');
var Choices = require( path.join(path.dirname(inquirerPath),'/objects/choices.js'));
var path = require('path');
var fs = require('fs');
module.exports = function(grunt) {
    grunt.registerTask('_change-activeWebpackage', 'Change the active webpackage.', function() {
        ...
        var configFile;
        try {
            var configFile = grunt.file.readJSON(workspaceConfigPath);
        } catch(err){
